...
'Version number help'				=>	'Show version number in footer.',
...
'Clickable links help'				=>	'When enabled, will automatically detect any URLs in posts and make them clickable hyperlinks.',
...
'Quick post help'					=>	'When enabled,  will add a quick reply form at the bottom of topics. This way users can post directly from the topic view.',
...
'Upload directory help'				=>	'The upload directory for avatars. PHP must have write permissions to this directory.',
...
'Report new help'					=>	'If enabled, will notify users on the mailing list (see above) when a new user registers in the forums.',
