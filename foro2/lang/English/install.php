...
'Already installed'				=>	'It seems like is already installed. You should go <a href="index.php">here</a> instead.',
'You are running error'			=>	'You are running %1$s version %2$s. %3$s requires at least %1$s %4$s to run properly. You must upgrade your %1$s installation before you can continue.',
'My FluxBB Forum'				=>	'My Forum',
'Description'					=>	'Unfortunately no one can be told what is - you have to see it for yourself.',
...
'No DB extensions'				=>	'This PHP environment does not have support for any of the databases that supports. PHP needs to have support for either MySQL, PostgreSQL or SQLite in order to be installed.',
'Administrator username'		=>	'Administrator\'s username',
'Administrator email'			=>	'Administrator\'s email',
'Board title'					=>	'Board title',
'Base URL'						=>	'The URL (without trailing slash) of your forum. This must be correct.',
'Required field'				=>	'is a required field in this form.',
'FluxBB Installation'			=>	'',
'Welcome'						=>	'You are about to install. In order to install, you must complete the form set out below. If you encounter any difficulties with the installation, please refer to the documentation.',
'Install'						=>	'',
...
'Info 4'						=>	'The name of the database you want to install.',
...
'Info 6'						=>	'If you want to run multiple installations in a single database, change this.',
...
'Existing table error'			=>	'A table called \'%susers\' is already present in the database \'%s\'. This could mean that is already installed or that another piece of software is installed and is occupying one or more of the table names requires. If you want to install multiple copies in the same database, you must choose a different table prefix',
...
'Message'						=>	'If you are looking at this (which I guess you are), Now log in and head over to the administration control panel to configure your forum.',
'Test category'					=>	'Test category',
'Test forum'					=>	'Test forum',
'This is just a test forum'		=>	'This is just a test forum',
'Alert cache'					=>	'<strong>The cache directory is currently not writable!</strong> In order for to function properly, the directory <em>%s</em> must be writable by PHP. Use chmod to set the appropriate directory permissions. If in doubt, chmod to 0777.',
...
'FluxBB has been installed'		=>	'',
'Final instructions'			=>	'Final instructions',
'Info 17'						=>	'To finalize the installation, you need to click on the button below to download a file called config.php. You then need to upload this file to the root directory of your installation.',
'Info 18'						=>	'Once you have uploaded config.php, will be fully installed! At that point, you may <a href="index.php">go to the forum index</a>.',
'Download config.php file'		=>	'Download config.php file',
'FluxBB fully installed'		=>	'has been fully installed! You may now <a href="index.php">go to the forum index</a>.',
