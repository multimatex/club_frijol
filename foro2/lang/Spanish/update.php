...
'Update'						=>	'Actualizar',
'Update message'				=>	'Su base de datos esta desactualizada y se debe actualizar para poder continuar. Si usted es el administrador del foro, por favor, siga las siguientes instrucciones para completar la actualización.',
'Note'							=>	'Nota:',
...
'Database password info'		=>	'Para llevar a cabo la actualización de la base de datos por favor, introduzca la contraseña de la base de datos con la que se instaló. Si no la recuerda, esta se encuentra en el archivo \'config.php\' .',
...
'You are running error'			=>	'Está ejecutando %1$s version %2$s. %3$s requiere por lo menos %1$s %4$s para funcionar correctamente. Debe actualizar su instalación %1$s antes de poder continuar.',
'Version mismatch error'		=>	'Versión desfasada. La base de datos \'%s\' no parece estar funcionando con una esquema de base de datos compatible con este script de actualización.',
...
'Invalid password error'		=>	'Contraseña de la base de datos invalida. Para actualizar debe introducir la contraseña de la base de datos exactamente como aparece en su \'%s\'',
...
'Error info 1'					=>	'Hubo un error convirtiendo a algunos usuarios. Si varios usuarios se han registrado con los nombres de usuario muy similares, por ejemplo "bob" y "böb".',
