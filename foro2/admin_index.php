...
if ($action == 'check_upgrade')
{
	...
	if (version_compare($pun_config['o_cur_version'], $latest_version, '>='))
		...
		message(sprintf($lang_admin_index['New version available message'], ''));
}
// Remove install.php
		...
		<div id="adstats" class="box">
			<div class="inbox">
				<dl>
					...
					<dd>
						<a ><?php echo $lang_admin_index['Forum label'] ?></a> - <a ><?php echo $lang_admin_index['IRC label'] ?></a>
					</dd>
				</dl>
			</div>
		</div>
