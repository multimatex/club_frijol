...
<div class="box">
	...
	<div class="inbox">
		...
		<p><code>[img=<?php echo $lang_help['code test'] ?>]<?php echo pun_htmlspecialchars(get_base_url(true)) ?>/img/test.png[/img]</code> <?php echo $lang_help['produces'] ?> <samp><img style="height: 21px" src="<?php echo pun_htmlspecialchars(get_base_url(true)) ?>/img/test.png" alt="<?php echo $lang_help['code test'] ?>" /></samp></p>
	</div>
</div>
